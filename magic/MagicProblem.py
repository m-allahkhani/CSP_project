...
class MagicProblem(Problem):
    def __init__(self):
        ...
        aldo = Variable(domain, "Aldo")
        beatrice = Variable(domain1, "Beatrice")
        ignatius = Variable(domain2, "Ignatius")
        lorenzo = Variable(domain3, "Lorenzo")
        ursula = Variable(domain4, "Ursula")
